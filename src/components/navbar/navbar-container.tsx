...
const NavbarContainer = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <header
      className={`flex flex-col bg-white lg:flex-row justify-between items-center py-4  px-5 top-0 z-[100] fixed w-full -translate-x-1/2 left-1/2 max-w-screen-2xl `}
      style={
        {
