...
const NavbarContainer = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <header
      className={`flex flex-col  bg-[#E6D9C5] lg:flex-row justify-between items-center py-4  px-5 top-0 z-[100] fixed w-full -translate-x-1/2 left-1/2 max-w-screen-4xl `}
      style={
        {
